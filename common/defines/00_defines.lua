...
NGame = {
	...
	SAVE_VERSION = 10,								-- 1.11.0 (Barbarossa)	CHECKSUM_SALT = "zwOdv5d9wm9uDSOT",				-- Data to modify generated checksum when game binaries have changed but not any content files.
	...
	MESSAGE_TIMEOUT_DAYS = 60,						-- Useful if running the handsoff game. The popup messages that doesn't require the player respond will automatically hide after some timeout.	AIR_LOG_TIMEOUT_HOURS = 24,						-- Data storring data
...
NMilitary = {
	...
	LOW_ORG_FOR_ATTACK = 0.4,                      -- at what org % we start affecting speed when doign hostile moves. scales down ZERO_ORG_MOVEMENT_MODIFIER
...
NAI = {
	...
	DEPLOY_MIN_EQUIPMENT_PEACE_FACTOR = 0.98,	-- Required percentage of equipment (1.0 = 100%) for AI to deploy unit in peacetime	-- Required percentage of equipment (1.0 = 100%) for AI to deploy unit in peacetime
	...
	FRONT_TERRAIN_DEFENSE_FACTOR = 3.75,        -- Multiplier applied to unit defense modifier for terrain on front province multiplied by terrain importan	FRONT_TERRAIN_ATTACK_FACTOR = 5.0,			-- Multiplier applied to unit attack modifier for terrain on enemy front province multiplied by terrain importance
	...
	THEORIST_ACCEPTANCE_MULTIPLIER = 0.7,						-- scale the acceptance of hiring a theorist by this number times the amount of non-theoris
